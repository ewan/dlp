...
//
	...
	class PostA0Dist extends ProbDistMC<Double2D> { // FIXME cause its off somewhere else
	...
	class PostRhoDist extends ProbDistMC<Double0D> {
	...
	class PostRho0Dist extends ProbDistMC<Double0D> {
