...
public class MpgHModel extends MpgFModel {
	...
	class PostNuBsDist extends ProbDistMC<Double1D> {
		...
		protected void setUpFromChainParms() {
			...
			for (Integer0D k : active) {
				...
				Double0D a = a0.plus(0.5*((double) MpgHModel.this.getDims()));
	...
	public MpgHModel(Map<String, Numeric<? extends Numeric<?>>> hypers,
