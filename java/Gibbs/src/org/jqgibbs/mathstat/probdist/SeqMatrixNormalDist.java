...
public class SeqMatrixNormalDist extends
		SequentialProbDist<Double3D, Double2D, MatrixNormalDist> {
	public SeqMatrixNormalDist(Numeric<?>... parms) throws ProbDistParmException {
		super(parms);
		...
		this.setProbDist(new MatrixNormalDist(settingsAll.get(0)));	
	}
