...
//
//public class SeqWishartDist extends
//		SequentialProbDist<Double3D, Double2D, WishartDist> {
//
//	public SeqWishartDist(Numeric... parms)
...
//		this.setProbDist(new WishartDist(settingsAll.get(0)));			
//	}
//
